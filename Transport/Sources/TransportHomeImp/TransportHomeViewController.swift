...
final class TransportHomeViewController: UIViewController, TransportHomePresentable, TransportHomeViewControllable, TopupBaseViewControllable {
    ...
    func setRidePrice(_ ridePrice: String) {
        rideTypeView.setPrice(ridePrice)
    }
    init() {
    ...
    private func didTapRideConfirmButton() {
        listener?.listenToRideConfirmButtonTapped()
    }
}

extension TransportHomeViewController: UIAdaptivePresentationControllerDelegate {
    func presentationControllerDidDismiss(_ presentationController: UIPresentationController) {
        listener?.listenToScreenDismissed()
    }
}
