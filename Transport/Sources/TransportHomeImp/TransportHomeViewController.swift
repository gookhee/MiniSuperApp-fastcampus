...
// MARK: - TransportHomeViewController

final class TransportHomeViewController: UIViewController, TopupBaseViewControllable {
    var interactor: TransportHomeRequestLogic?
    ...
    override func viewDidLoad() {
        ...
        setupViews()
        interactor?.process(TransportHome.Request.OnLoad())
    }
    ...
    private func backButtonDidTap() {
        interactor?.process(TransportHome.Request.OnGoBack())
    }
    
    @objc
    private func didTapRideConfirmButton() {
        interactor?.process(TransportHome.Request.OnRideConfirmButton())
    }
}

// MARK: - TransportHomeDisplayLogic

extension TransportHomeViewController: TransportHomeDisplayLogic {
    func display(_ viewModel: TransportHome.ViewModel.SuperPayBalance) {
        superPayView.setBalanceText("잔고: \(viewModel.text)원")
    }
    
    func display(_ viewModel: TransportHome.ViewModel.RidePrice) {
        rideTypeView.setPrice(viewModel.text)
    }
}
...
extension TransportHomeViewController: UIAdaptivePresentationControllerDelegate {
    func presentationControllerDidDismiss(_ presentationController: UIPresentationController) {
        interactor?.process(TransportHome.Request.OnViewDidDismiss())
    }
}
